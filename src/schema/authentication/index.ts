...
export const LoginSchema = z.object({
  email: z.string().nonempty({ message: "Your email is required" }),
  password: z.string().nonempty({ message: "Your password is required" }),
});
...
export const RegisterSchema = z
  .object({
    ...
    phone: z
      ...
      .regex(/^(010|011|012|015)[0-9]{8}$|^05[0-9]{8}$/, {
...
export const NewPasswordSchema = z
  .object({
    ...
    confirmPassword: z
      .string()
      .nonempty({ message: "Your confirm confirm password is required" })
      .optional(),
  })
