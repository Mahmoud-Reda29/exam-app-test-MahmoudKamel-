              ...
              <main id="settings-page" className="mt-6 flex gap-6">
                     <Asidebar className="bg-white min-w-72 p-6">
                            <ul className={cn("links | flex-auto gap-2")} aria-label="list links">
                                   <AsideLink href="/account" active={ACTIVE_LINK}><UserAccountIcon /> Profile</AsideLink>
                                   <AsideLink href="/account/change-password" active={ACTIVE_LINK}><LocIcon /> Change Password</AsideLink>
                            </ul>
                     </Asidebar>
                     {children}
              </main>
