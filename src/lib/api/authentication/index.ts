...
import { AuthResponse, ForgetPasswordData, ForgetPasswordResponse, LoginData, NewPasswordData, NewPasswordResponse, SignupData, VerifyResetCodeData, VerifyResetCodeResponse } from "@lib/types/api/authentication";
...
export async function postForgotPassword(data:ForgetPasswordData):Promise<ForgetPasswordResponse> {
       try {
...
export async function postVerifyResetCode(data:VerifyResetCodeData):Promise<VerifyResetCodeResponse> {
       try {
