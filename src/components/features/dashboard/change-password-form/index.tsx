...
export default function ChangePasswordForm() {
  ...
  } = useForm<FormInput<typeof ChangePasswordFormSchema>>({
    ...
    >
      ...
      >
        ...
        {errors.currentPassword && (
          <p className="invalid | text-sm text-red-600">{errors.currentPassword.message}</p>
        )}
      </div>
      ...
      >
        ...
        {errors.confirmNewPassword && (
          <p className="invalid | text-sm text-red-600">{errors.confirmNewPassword.message}</p>
        )}
      </div>
