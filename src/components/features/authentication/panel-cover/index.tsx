...
export default function PanelCover() {
  return (
    ...
    >
      <span
        className={cn(
          "mb-title-panel-cover flex items-center gap-2 text-xl font-semibold text-blue-600"
        )}
      >
        <FolderCodeIcon /> Exam App
      </span>
      <div>
        <h2 className={cn(`mb-16 text-3xl font-bold ${inter.className}`)}>
        ...
        <ul className="flex flex-col gap-9">
          ...
          <li className="flex items-start gap-5">
            ...
            <div>
              <h3 className={cn("mb-3 text-blue-600 text-xl font-semibold")}>
