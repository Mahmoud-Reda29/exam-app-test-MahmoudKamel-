...
export default function FormRegister() {
  ...
  } = useForm<FormInput<typeof RegisterSchema>>({ resolver: zodResolver(RegisterSchema) });
    ...
    <>
      ...
      >
        ...
        <div className={cn("password | w-full mb-4 flex flex-col gap-2 text-gray-800 font-medium")}>
          ...
          />
          {errors.password && (
            <p className="invalid | text-sm text-red-600">{errors.password.message}</p>
          )}
        </div>

        <div
          className={cn("confirm-password | w-full flex flex-col gap-2 text-gray-800 font-medium")}
        >
          ...
          />
          {errors.rePassword && (
            <p className="invalid | text-sm text-red-600">{errors.rePassword.message}</p>
          )}
        </div>
